    ...
    <div className="bg-[#FAFAFA]">
      <HeroBackGround>
        <div className="flex h-full w-full flex-col items-center justify-center gap-y-3 leading-relaxed">
          <p className="font-PoppinsRegular text-white xs:text-base sm:text-lg md:text-xl lg:text-2xl">
            <span className="font-PoppinsMedium"> {displayedData?.length}</span>{" "}
            Jobs For Developers
          </p>
          <p className="flex items-center font-PoppinsRegular text-base text-white">
            {" "}
            Home <IoIosArrowForward className="mx-2 md:mx-3 rtl:rotate-180" />{" "}
            Jobs
          </p>
        </div>
      </HeroBackGround>
