...
export default function TopRatedJobs({ job }) {
  ...
  return (
    ...
    >
      <p className="my-2 self-center font-PoppinsSemiBold text-base
 text-[#444444]">
      ...
      <p className="self-center text-center font-PoppinsSemiBold text-base text-[#3B235D]">
      ...
      <div className="mx-auto mb-1 mt-2 flex w-full items-start justify-center gap-x-1">
      ...
      <hr className="my-2 w-11/12 self-center border-[1px] border-black" />
