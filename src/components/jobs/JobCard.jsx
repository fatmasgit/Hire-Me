...
export default function JobCard({ job }) {
  ...
  return (
    <div className="border flex w-full rounded-lg bg-gray-200 px-1">
      {/* card img */}
      <div className="w-1/3 rounded-lg bg-gray-200 pt-3">
        <img
          className="mx-auto xs:h-20 sm:h-24 w-5/6 rounded-md object-cover"
          src={job?.companyImage}
          alt="Company logo"
        />

        {/* location */}
        <div className="mx-auto mb-1 mt-3 flex items-start justify-center gap-x-1 xs:w-3/5 md:w-full">
          <SlLocationPin size={20} />
          <p className="font-PoppinsRegular text-gray-700 xs:text-xs md:text-sm">
      ...
      {/* card text */}
      <div className="w-2/3 bg-gray-200 py-3 ps-1">
        ...
        <div className="flex gap-x-1">
          <p className="font-PoppinsRegular text-gray-700 xs:text-sm md:text-base">
            {job?.workMode}
          </p>
        </div>

        <div className="flex w-full justify-between xs:flex-col xs:items-start md:flex-row md:items-center">
