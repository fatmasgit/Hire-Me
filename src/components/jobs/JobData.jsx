  ...
  return (
    <div className="mt-4 flex w-full flex-col gap-y-4 leading-relaxed">
      ...
      <div className="w-full rounded-md bg-gray-200 p-4">
        {/* Heading */}
        <p className="mb-1 font-PoppinsSemiBold text-base text-gray-700">
          Job Description
        </p>
        {/* Job description text */}
        {job?.jobDescription ? (
          <div
            className="font-PoppinsRegular text-sm text-gray-700 leading-relaxed"
            dangerouslySetInnerHTML={{
              __html: DOMPurify.sanitize(addListClasses(job.jobDescription)),
            }}
          />
        ) : (
          <p className="font-PoppinsRegular text-sm text-gray-700">
      ...
      {/* Job requirements */}
      <div className="w-full rounded-md bg-gray-200 p-4 leading-relaxed">
        {/* Heading */}
        <p className="mb-1 font-PoppinsSemiBold text-base text-gray-700">
          Job Requirements
        </p>
        {job?.jobRequirements ? (
          typeof job.jobRequirements === "string" ? (
            <div
              className="font-PoppinsRegular text-sm text-gray-700"
              dangerouslySetInnerHTML={{
