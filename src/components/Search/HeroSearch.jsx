...
export default function HeroSearch() {
  ...
  return (
    <div className="h-[32rem] w-full bg-Hero bg-cover bg-no-repeat xs:bg-left">
      {/* Could replace h-[32rem] with h-128 if added in Tailwind config */}
      <div className="flex h-full w-full flex-col items-center justify-center gap-y-3 bg-overlay">
        <p className="font-PoppinsRegular tracking-wider text-white xs:text-xl md:text-2xl xl:text-3xl">
          {t("searchResults")}
        </p>
        <p className="-mt-6 flex items-center font-PoppinsRegular text-sm text-white md:text-base mb-4">
          {t("home")}{" "}
