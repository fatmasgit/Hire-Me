...
import { persistor } from "../../store"; // 🔥 import persistor here
  ...
  return (
    <div className="hidden lg:block sticky top-0 z-50 bg-white">
      <div className="flex items-center justify-between lg:h-[3.5rem] xl:h-[4rem] px-3">
        <div className="flex h-full items-center justify-start px-2 lg:gap-x-3 xl:gap-x-4">
          ...
          <div className="ltr:font-PoppinsMedium rtl:font-TajawalBold text-[#444444] lg:text-sm xl:text-base">
          ...
          <div className="relative font-PoppinsSemiBold text-[#444444] lg:text-sm xl:text-base">
            <Options />
          </div>
        </div>
        ...
        <div className="mx-2 flex h-full items-center justify-end gap-x-2">
          ...
          {(!authenticated || (authenticated && role === 'employer')) && (
            <Link to="SignUp" className="!no-underline">
              <button className="ltr:font-PoppinsMedium rtl:font-TajawalMedium 
                ...
                lg:h-[1.8rem] lg:w-[5.7rem] lg:text-xs xl:h-[2rem] xl:w-[7.8rem] xl:text-sm">
                {t("Sign Up")}
              </button>
            </Link>
          )}
          ...
          {(!authenticated || (authenticated && role === 'candidate')) && (
            <Link to="/employers/SignUp" className="!no-underline">
              <button className="ltr:font-PoppinsMedium rtl:font-TajawalMedium 
                rounded-md border-[1px] border-solid border-[#3B235D] text-[#3B235D] 
                lg:h-[1.8rem] lg:w-[6.5rem] lg:text-xs xl:h-[2rem] xl:w-[8.2rem] xl:text-sm">
                {t("For Employers")}
              </button>
            </Link>
          )}
