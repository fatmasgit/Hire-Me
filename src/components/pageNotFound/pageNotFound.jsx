...
export default function PageNotFound() {
    ...
    return (
        ...
        <div className='mx-auto flex flex-col gap-y-3 w-4/5  md:w-3/5 justify-center items-center min-h-screen pt-5 py-2 select-none'>
            ...
            <button onClick={() => { navigate('/') }} className="px-2 py-2 rounded-md   w-[6rem] bg-[#3B235D]  text-white font-PoppinsRegular "  > Home  </button>
            <img src={error} className=' h-80 sm:h-100' />
        </div>
    )
}
