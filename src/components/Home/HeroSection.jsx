  ...
  return (
    <div className="w-full" dir={direction}>
      <div className="h-[34rem] w-full bg-Hero bg-cover bg-no-repeat">
        <div className="flex h-full w-full flex-col items-center justify-start gap-y-8 bg-overlay pt-5">
          <p className="text-[#FFFFFF] xs:text-lg sm:text-2xl lg:text-3xl ltr:font-PoppinsRegular rtl:font-TajawalRegular">
